function [Point_cell, Seq_cell] = BCC2TCubeGenerator_5(L_cell,Var,Dirct)
...
Point_cell(1:3,3)=[ -1, 0, -0.5]*L_cell/2.*[1, 1, 2-Var_P(1)];
Point_cell(1:3,4)=[  1, 0, -0.5]*L_cell/2.*[1, 1, 2-Var_P(2)];
...
Point_cell(1:3,9)=[ 0,  -1,0]*L_cell/2.*[1,1, 1];
Point_cell(1:3,10)=[ 0, 1,0]*L_cell/2.*[1,1, 1];


Point_cell(1:3,11)=[ -1,0, 1]*L_cell/2.*[1,1,1];
Point_cell(1:3,12)=[ 1, 0, 1]*L_cell/2.*[1,1,1];

Point_cell(1:3,13)=[ -1, 0,  0.5]*L_cell/2.*[1, 1, 2-Var_P(1)];
Point_cell(1:3,14)=[  1, 0,  0.5]*L_cell/2.*[1, 1, 2-Var_P(2)];
...
%%
%non-shared
Seq_cell{1}=[5 3;  5 13; 7 3; 7 13; 
             6 4;  6 14; 8 4; 8 14; 
             5 9; 6 9; 7 10 ; 8 10];%

%shared in local Face X 
Seq_cell{2}{1}=[1 3; 11 13];% 
Seq_cell{2}{2}=[2 4; 12 14 ];%
% Seq_cell{2}{1}=[1 3;  ];%
% Seq_cell{2}{2}=[  12 14 ];%
